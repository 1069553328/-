...
public class Phone_inquiry extends javax.swing.JFrame {
	...
	public Phone_inquiry(String username) {
	...
	void inquiry() {
		...
		try {
			...
			String table_phone = "'" + phone + "'";
			res = sql.executeQuery("select * from users where phone=" + table_phone);
			if(res.next()) {
